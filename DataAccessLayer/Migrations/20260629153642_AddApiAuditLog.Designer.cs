...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260629153642_AddApiAuditLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Models.ApiAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DomainLayer.Models.Doctor", b =>
                {
                    ...
                    b.Property<string>("IdImageBackUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("IdImageFrontUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("DomainLayer.Models.DoctorEarning", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Models.DoctorSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Models.SavedPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("DoctorAdvicePostId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DoctorAdvicePostId");

                    b.HasIndex("UserId", "DoctorAdvicePostId")
                        .IsUnique();
            ...
            modelBuilder.Entity("DomainLayer.Models.SavedPost", b =>
                {
                    b.HasOne("DomainLayer.Models.DoctorAdvicePost", "DoctorAdvicePost")
                        .WithMany()
                        .HasForeignKey("DoctorAdvicePostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
